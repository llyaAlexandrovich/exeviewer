...
{
    printf("IMAGE_DOS_HEADER::e_magic=0x%x=>MZ\n", idh->e_magic);
    printf("IMAGE_DOS_HEADER::e_cblp=0x%x=>%o\n", idh->e_cblp, idh->e_cblp);
    printf("IMAGE_DOS_HEADER::e_cp=0x%x=>%o\n", idh->e_cp, idh->e_cp);
    printf("IMAGE_DOS_HEADER::e_crlc=0x%x=>%o\n", idh->e_crlc, idh->e_crlc);
    printf("IMAGE_DOS_HEADER::e_cparhdr=0x%x=>%o\n", idh->e_cparhdr, idh->e_cparhdr);
    printf("IMAGE_DOSC_HEADER::e_minalloc=0x%x=>%o\n", idh->e_minalloc, idh->e_minalloc);
    printf("IMAGE_DOS_HEADER::e_maxalloc=0x%x=>%o\n", idh->e_maxalloc, idh->e_maxalloc);
    printf("IMAGE_DOS_HEADER::e_ss=0x%x=>%o\n", idh->e_ss, idh->e_ss);
    printf("IMAGE_DOS_HEADER::e_sp=0x%x=>%o\n", idh->e_sp, idh->e_sp);
    printf("IMAGE_DOS_HEADER::e_csum=0x%x=>%o\n", idh->e_csum, idh->e_csum);
    printf("IMAGE_DOS_HEADER::e_ip=0x%x=>%o\n", idh->e_ip, idh->e_ip);
    printf("IMAGE_DOS_HEADER::e_cs=0x%x=>%o\n", idh->e_cs, idh->e_cs);
    printf("IMAGE_DOS_HEADER::e_lfarlc=0x%x=>%o\n", idh->e_lfarlc, idh->e_lfarlc);
    printf("IMAGE_DOS_HEADER::e_ovno=0x%x=>%o\n", idh->e_ovno, idh->e_ovno);
    printf("IMAGE_DOS_HEADER::e_res[0]=0x%x=>%o\n", idh->e_res[0], idh->e_res[0]);
    printf("IMAGE_DOS_HEADER::e_res[1]=0x%x=>%o\n", idh->e_res[1], idh->e_res[1]);
    printf("IMAGE_DOS_HEADER::e_res[2]=0x%x=>%o\n", idh->e_res[2], idh->e_res[2]);
    printf("IMAGE_DOS_HEADER::e_res[3]=0x%x=>%o\n", idh->e_res[3], idh->e_res[3]);
    printf("IMAGE_DOS_HEADER::e_oemid=0x%x=>%o\n", idh->e_oemid, idh->e_oemid);
    printf("IMAGE_DOS_HEADER::e_oeminfo=0x%x=>%o\n", idh->e_oeminfo, idh->e_oeminfo);
    printf("IMAGE_DOS_HEADER::e_res2[0]=0x%x=>%o\n", idh->e_res2[0], idh->e_res2[0]);
    printf("IMAGE_DOS_HEADER::e_res2[1]=0x%x=>%o\n", idh->e_res2[1], idh->e_res2[1]);
    printf("IMAGE_DOS_HEADER::e_res2[2]=0x%x=>%o\n", idh->e_res2[2], idh->e_res2[2]);
    printf("IMAGE_DOS_HEADER::e_res2[3]=0x%x=>%o\n", idh->e_res2[3], idh->e_res2[3]);
    printf("IMAGE_DOS_HEADER::e_res2[4]=0x%x=>%o\n", idh->e_res2[4], idh->e_res2[4]);
    printf("IMAGE_DOS_HEADER::e_res2[5]=0x%x=>%o\n", idh->e_res2[5], idh->e_res2[5]);
    printf("IMAGE_DOS_HEADER::e_res2[6]=0x%x=>%o\n", idh->e_res2[6], idh->e_res2[6]);
    printf("IMAGE_DOS_HEADER::e_res2[7]=0x%x=>%o\n", idh->e_res2[7], idh->e_res2[7]);
    printf("IMAGE_DOS_HEADER::e_res2[8]=0x%x=>%o\n", idh->e_res2[8], idh->e_res2[8]);
    printf("IMAGE_DOS_HEADER::e_res2[9]=0x%x=>%o\n", idh->e_res2[9], idh->e_res2[9]);
    printf("IMAGE_DOS_HEADER::e_lfanew=0x%lx=>%lo\n", idh->e_lfanew, idh->e_lfanew);
}
...
{
    printf("IMAGE_NT_HEADERS32::Signature=0x%lx=>%s\n", inh->Signature, "PE");
    printf("IMAGE_NT_HEADERS32::IMAGE_FILE_HEADER::Machine=0x%x=>%s\n", inh->FileHeader.Machine, DETERMINE_MACHINE(inh->FileHeader.Machine));
    printf("IMAGE_NT_HEADERS32::IMAGE_FILE_HEADER::NumberOfSections=0x%x=>%o\n", inh->FileHeader.NumberOfSections, inh->FileHeader.NumberOfSections);
    printf("IMAGE_NT_HEADERS32::IMAGE_FILE_HEADER::TimeDateStamp=0x%lx=>%s", inh->FileHeader.TimeDateStamp, DetermineTimeDateStamp(inh->FileHeader.TimeDateStamp));
    printf("IMAGE_NT_HEADERS32::IMAGE_FILE_HEADER::PointerToSymbolTable=0x%lx=>%lo\n", inh->FileHeader.PointerToSymbolTable, inh->FileHeader.PointerToSymbolTable);
    printf("IMAGE_NT_HEADERS32::IMAGE_FILE_HEADER::NumberOfSymbols=0x%lx=>%lo\n", inh->FileHeader.NumberOfSymbols, inh->FileHeader.NumberOfSymbols);
    printf("IMAGE_NT_HEADERS32::IMAGE_FILE_HEADER::SizeOfOptionalHeader=0x%x=>%o\n", inh->FileHeader.SizeOfOptionalHeader, inh->FileHeader.SizeOfOptionalHeader);
    printf("IMAGE_NT_HEADERS32::IMAGE_FILE_HEADER::Characteristics=0x%x=>", inh->FileHeader.Characteristics);
    DetermineCharacteristics((volatile WORD)inh->FileHeader.Characteristics);
